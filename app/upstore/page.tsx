    ...
    <div className="min-h-screen section-bg-gradient">
      <div className="section-padding max-container py-16">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-secondary mb-4 font-inter">
            85-UpStore
          </h1>
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="card-acrylic p-8 md:p-12">
            <h2 className="text-3xl md:text-4xl font-bold text-secondary mb-8 text-center font-inter">
              利用ガイドライン
            </h2>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="card-acrylic p-8">
            <h2 className="text-2xl md:text-3xl font-bold text-secondary mb-6 font-inter">
              お問い合わせ・ご予約
            </h2>
