    ...
    <article className="card-acrylic group">
      <a href={article.url} target="_blank" rel="noopener noreferrer">
        <div className="relative h-48 sm:h-52 md:h-48 w-full overflow-hidden bg-gray-100 rounded-t-lg">
          ...
          />
          {/* noteバッジ */}
          <div className="absolute top-2 right-2 bg-white/90 backdrop-blur-sm text-gray-900 text-sm px-2 py-1 rounded font-semibold flex items-center gap-1 border border-gray-200">
